...
public class Ejercicio02 {
	...
	public static void main(String[] args) {
		...
		/*Leer tres números enteros de la consola y
		...
		System.out.println("Dame un último numero entero: ");
		num3 = scanner.nextInt();
		
		if(num1 != num2 && num1 != num2 && num2 != num3) {
			System.out.println("No hay ningún numero igual");
		} else {
			if(num1 == num2 || num1 == num2 || num2 == num3) {
				System.out.println("Hay algun número igual");
		}
